...
description: Use when validating the deployed Agent Skill Catalog site with Chrome DevTools/CDP. Triggers: 本番サイト確認, 404チェック, GitHubリンク確認, referencesリンク確認, console/network確認.
---
